...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    '/match/components/BetSlipModal': RouteRecordInfo<'/match/components/BetSlipModal', '/match/components/BetSlipModal', Record<never, never>, Record<never, never>>,
    '/match/components/MatchItem': RouteRecordInfo<'/match/components/MatchItem', '/match/components/MatchItem', Record<never, never>, Record<never, never>>,
    '/match/components/MatchList': RouteRecordInfo<'/match/components/MatchList', '/match/components/MatchList', Record<never, never>, Record<never, never>>,
